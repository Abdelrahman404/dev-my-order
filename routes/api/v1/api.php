...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    // START DECEMBER TASKS
    Route::post('customer/follow/user', 'FollowingController@store')->middleware('auth:api');
    Route::post('customer/unfollow/user', 'FollowingController@destroy')->middleware('auth:api');

    // POSTS
    Route::post('customer/post/store', 'PostController@store')->middleware('auth:api');

    // STORIES
    Route::post('customer/story/store', 'StoryController@store')->middleware('auth:api');

    // HIGHLIGHT
    Route::post('customer/highlight/store', 'HightlightController@store')->middleware('auth:api');

    // HOME PAGE
    Route::get('customer/home', 'HomeController@index')->middleware('auth:api');
    Route::get('customer/home/discover', 'HomeController@discover')->middleware('auth:api');
    // DISCOVERY TAB
    Route::get('customer/post/{id}', 'HomeController@postDetails')->middleware('auth:api');
    Route::post('customer/post/like', 'HomeController@likePost')->middleware('auth:api');
    Route::post('customer/post/unlike', 'HomeController@unlikePost')->middleware('auth:api');
    Route::post('customer/post/comment', 'HomeController@addComment')->middleware('auth:api');
    Route::post('customer/post/comment', 'HomeController@addComment')->middleware('auth:api');

    // WATCHLIST
    Route::get('customer/watchlist/', 'WatchlistController@index')->middleware('auth:api');
    Route::get('customer/watchlist/collection/items', 'WatchlistController@getCollectionItems')->middleware('auth:api');
    Route::post('customer/watchlist/item/add', 'WatchlistController@addItem')->middleware('auth:api');
    Route::post('customer/watchlist/item/delete', 'WatchlistController@deleteItem')->middleware('auth:api');
    Route::post('customer/watchlist/collection/create', 'WatchlistController@createCollection')->middleware('auth:api');
    Route::post('customer/watchlist/collection/add-item', 'WatchlistController@addItemToCollection')->middleware('auth:api');
    Route::post('customer/watchlist/collection/remove-item', 'WatchlistController@removeItemFromCollection')->middleware('auth:api');
    // PROFILE SCREEN
    
    Route::get('customer/profile/', 'CustomerProfileController@index')->middleware('auth:api');
